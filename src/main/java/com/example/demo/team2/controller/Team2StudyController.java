...
public class Team2StudyController {
	...
	public String saveStudyLog(@ModelAttribute @Validated Team2StudyLogsForm team2StudyLogsForm, BindingResult result, HttpSession session, Model model) {
	...
	public String update(@PathVariable int id, @ModelAttribute @Validated Team2StudyLogsForm team2StudyLogsForm, BindingResult result) {
