...
public class Team2QuestionController {
	...
	public String createQuestion(Model model, HttpServletRequest request, HttpSession session) {

		model.addAttribute("team2QuestionForm", new Team2QuestionForm());

		String referer = request.getHeader("Referer");
		session.setAttribute("questionCreateBackUrl", referer);
	...
	public String createQuestion(@ModelAttribute @Validated Team2QuestionForm team2QuestionForm, BindingResult result,
			HttpSession session,
			Model model) {
